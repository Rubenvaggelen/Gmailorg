...
function wireRoutePage() {
  ...
  document.getElementById("route-page-ov-search-btn").addEventListener("click", async () => {
    ...
    const fromStops = nearestStops(fromLocation, 3);
    ...
    if (!any) { statusEl.classList.remove("hidden"); statusEl.textContent = "Geen haltes of vertrektijden gevonden in de buurt van dit adres."; }
  });
